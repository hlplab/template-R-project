...
header-includes: 
 ...
 - \usepackage{tipa}      # Additional IPA support
...
# specific R chunk.
options(
   width = 200, digits = 5, OutDec = ".", 
   # control how much information tinytex leaves of the interim steps while knitting
   tinytex.clean = TRUE, tinytex.verbose = TRUE)
base.width = 1.33
base.height = 1.33
...
knitr::opts_chunk$set(
  ...
  interval = .2,
  # default plot settings, including no floating
