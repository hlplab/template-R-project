...
# Introduction
This is an R Markdown-based template for APA articles, used by the Human Language Processing Lab at the University of Rochester. If you have questions or ideas on how to improve his template, please let us know, e.g., at [fjaeger@ur.rochester.edu](fjaeger@ur.rochester.edu).
...
To get started on using this manuscript, have a look at the index.Rmd file. It's the parent Rmd file that loads all the other Rmd files, one for each section of the paper. The index.Rmd file is also the file that is used to knit the entire document.
